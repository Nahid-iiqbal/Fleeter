        ...
        <Card elevation={0} sx={{ border: 1, borderColor: "divider" }}>
          <CardContent sx={{ p: 4 }}>
            ...
            {error ? (
              ...
              <Typography color="text.secondary">
                This manager could not be found.
              </Typography>
            )}
          </CardContent>
        </Card>
        ...
        <CardContent sx={{ p: 3 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={4}>
              <InfoItem label="Full Name" value={manager.full_name} />
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
              <InfoItem label="Employee ID" value={manager.employee_id} />
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
              <InfoItem
                label="Department"
            ...
            <Grid item xs={12} sm={6} md={4}>
              <InfoItem
                label="Username"
                value={manager.username || "Not linked"}
              />
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
