import { getAlertTypeColor, getAlertStatusColor, getAlertStatusLabel } from './alerts';
...
describe('alert utilities', () => {
  ...
  test('maps status labels to expected UI colors', () => {
    ...
    expect(getAlertStatusLabel(false, new Date('2026-01-01T00:00:00Z'))).toBe('deadline expired');
