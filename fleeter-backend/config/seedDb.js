...
async function createTrip(
  ...
  const departureExpr =
    departureDaysAgo >= 0
      ? daysAgo(departureDaysAgo)
      : daysFromNow(-departureDaysAgo);
...
async function createDriverDocument(
  ...
  const expiryExpr =
    expiryOffsetDays >= 0
      ? dateDaysFromNow(expiryOffsetDays)
      : dateDaysAgo(-expiryOffsetDays);
    ...
    const companyDefs = [
      {
        ...
        routes: [
          ...
          },
          {
            ...
            origin: "Warehouse A",
            destination: "Benapole Border Checkpoint",
            distanceKm: 260.0,
            estMins: 300,
          },
        ],
...

      {
        ...
        ownerFullName: "Daniel Sullivan",

        managers: [
          {
            username: "metro_dispatch",
            email: "metro.dispatch@fleeter.com",
            fullName: "Nina Patel",
            employeeId: "MT-001",
            phone: "555-0200",
            department: "Operations",
        ...
        drivers: [
          {
            username: "amir_s",
            email: "amir.s@fleeter.com",
            fullName: "Amir Siddiqui",
            phone: "555-0210",
            status: "dispatched",
            joinedDaysAgo: 500,
          },
          ...
          {
            username: "victor_m",
            email: "victor.m@fleeter.com",
            fullName: "Victor Mensah",
            phone: "555-0212",
            status: "available",
            joinedDaysAgo: 150,
          },
          ...
          {
            username: "oscar_p",
            email: "oscar.p@fleeter.com",
            fullName: "Oscar Pereira",
            phone: "555-0214",
            status: "terminated",
            joinedDaysAgo: 700,
          },
        ...
        routes: [
          {
            name: "Airport Cargo Express",
            origin: "Metro Depot",
            destination: "International Airport Cargo Wing",
            distanceKm: 18.3,
            estMins: 30,
          },
          {
            name: "Suburban Delivery Circuit",
            origin: "Metro Depot",
            destination: "Suburban Retail Park",
            distanceKm: 34.0,
            estMins: 55,
          },
          {
            ...
            origin: "Metro Depot",
            destination: "Riverside Industrial Zone",
            distanceKm: 27.5,
            estMins: 45,
          },
        ],
...

      {
        ...
        ownerFullName: "Olivia Bennett",

        managers: [
          {
            username: "gv_dispatch",
            email: "gv.dispatch@fleeter.com",
        ...
        drivers: [
          {
            username: "sam_c",
            email: "sam.c@fleeter.com",
            fullName: "Samuel Chowdhury",
            phone: "555-0310",
            status: "available",
            joinedDaysAgo: 380,
          },
          ...
          {
            username: "ines_v",
            email: "ines.v@fleeter.com",
            fullName: "Ines Varela",
            phone: "555-0312",
            status: "available",
            joinedDaysAgo: 80,
          },
        ...
        routes: [
          {
            name: "Highland Produce Run",
            origin: "Green Valley Yard",
            destination: "Highland Wholesale Market",
            distanceKm: 62.0,
            estMins: 80,
          },
          {
            ...
            origin: "Green Valley Yard",
            destination: "Coastal Cold Storage Facility",
            distanceKm: 88.0,
            estMins: 105,
          },
          {
    ...
    for (const key of Object.keys(companies)) {
      ...
      for (const [i, v] of co.vehicles.entries()) {
        ...
        await createVehicleDocument(client, {
          ...
          docNo: `FIT-${v.reg}`,
          issueDaysAgo: 180,
          expiryOffsetDays: 185,
        });
      }

      // Every driver gets ONLY a driving license.
